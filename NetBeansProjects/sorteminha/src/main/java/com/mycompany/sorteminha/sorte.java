 ...
 */
package com.mycompany.sorteminha;
...
int v1,v2,v3;
    ...
    private void btnSortearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSortearActionPerformed
        v1=(int)(Math.random()*9); 
        v2=(int)(Math.random()*9); 
        v3=(int)(Math.random()*9); 
        lbl1.setText(String.valueOF(v1));
        lbl2.setText(String.valueOF(v1));
        lbl3.setText(String.valueOF(v1));
        if(v1==v2)&&(v2==v3){
